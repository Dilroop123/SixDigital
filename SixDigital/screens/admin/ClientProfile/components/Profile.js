  ...
  return (
    <View style={styles.container}>
      <View
        ...
        <View style={{flex: 0.2,backgroundColor:color.successText,padding:SCREEN_HEIGHT * 0.003}}>
          <FontAwesome name="volume-control-phone" style={{color:color.white,fontSize:18}}/>
        </View>
      </View>
      <FlatList
        data={DATA}
