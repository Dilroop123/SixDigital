    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.addClientContainer}>
            <View style={{justifyContent:'center',alignItems:'center',flex:1,marginVertical:SCREEN_HEIGHT* 0.02}}>
                <Image source={require('../../../../assets/guest.png')} style={{height:100,width:100}}/>
            </View>
          <View
            style={{
              flexDirection: 'row',
